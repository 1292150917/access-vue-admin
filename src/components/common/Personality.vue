  ...
  >
    <div class="drawer-con">
      ...
      <div class="theme-wrap">
        <div
          class="item"
          v-for="(item, index) in dayThemeList"
          :key="item.theme"
          @click="setDarkTheme(item.theme)"
        >
          <div class="box">
      ...
      <div class="menu-theme-wrap">
        ...
        >
          <div class="box">
            ...
            <div
              class="left"
              :style="{ background: item.menuLeftBc + '!important' }"
            ></div>
          </div>
      ...
      <p class="title" style="margin-top: 35px">自定义</p>
      <div
        class="block"
        style="display: flex; align-items: center; margin-top: 11px"
      >
...
export default {
  ...
  watch: {
    color1(res) {
      ...
      this.$store.dispatch("setting/setUpTheme", res);
    },
  },
  methods: {
    // 初始化用户主题设置
